...
namespace Fungus
{
    ...
    public class TextAdapter : IWriterTextDestination
    {
        ...
        protected TMPro.TextMeshProUGUI tmpro;
#endif
...
#if UNITY_2018_1_OR_NEWER
                tmpro = go.GetComponent<TMPro.TextMeshProUGUI>();
#endif
...
#if UNITY_2018_1_OR_NEWER
                tmpro = go.GetComponentInChildren<TMPro.TextMeshProUGUI>();
#endif
        ...
        public char LastRevealedCharacter
        {
            get
            {
                ...
                if(tmpro != null)
                {
                    return tmpro.textInfo.characterInfo[tmpro.maxVisibleCharacters > 0 ? tmpro.maxVisibleCharacters - 1 : tmpro.maxVisibleCharacters + 1].character;
                }
#endif
                return (char)0;
            }
